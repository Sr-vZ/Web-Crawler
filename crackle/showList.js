...
url = 'https://web-api-us.crackle.com/Service.svc/browse/shows/full/all/alpha-asc/US/20/3?format=json';

pages = 4
for (i = 0; i < pages; i++) {
    pagedURLS[i] = 'https://web-api-us.crackle.com/Service.svc/browse/shows/full/all/alpha-asc/US/20/' + (i + 1) + '?format=json'
}
...
(async () => {
    ...
    fs.writeFileSync('crackle_showlist.json', JSON.stringify(kanopyDB, null, 2))
